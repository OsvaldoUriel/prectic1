...
public class Poblacion {//porque todo esto  esta en public
    ...
    public static void printCityPopulation(String city, double population) {
        ...
        System.out.println("Pero en la ciudad más poblada, " + Poblacion.city + ", la población es de " + Poblacion.population
                + " millones.");
